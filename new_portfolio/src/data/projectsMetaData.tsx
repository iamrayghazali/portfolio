export const projectsMeta = {
    "TheSweetSpot": {
        description: "Sweet Spot is built to simplify the ordering process for Nigerian food lovers in Budapest. It offers a smooth browsing and ordering experience through a responsive web app, complete with an admin interface for managing the menu and keeping content fresh.\n" +
            "\n" +
            "Customers can:\n" +
            "\n" +
